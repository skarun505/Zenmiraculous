...
//#region node_modules/.nitro/vite/services/ssr/assets/privacy-BgVPH0wZ.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				className: "mx-auto max-w-[760px] px-6 pb-24 pt-14",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "mb-2 text-[clamp(28px,4vw,42px)] font-bold text-[#fafafa]",
						children: "Privacy Policy"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mb-12 text-xs text-[#71717a]",
						children: "Last updated: July 25, 2026"
					}),
					[
						{
...
Calendly: calendly.com/harshvyas242424/business-automation-audit`
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mb-3 text-lg font-semibold text-[#fafafa]",
							children: section.title
						}), section.content.split("\n").map((line, i) => line.trim() === "" ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mb-2 text-sm leading-relaxed text-[#a1a1aa]",
							children: line
						}, i))]
					}, section.title)),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-12 border-t border-[#27272a] pt-8",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							href: "/",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				...
				children: "© 2026 Zen Miraculous. All rights reserved."
			})
		]
	});
}
