...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Privacy policy and data protection guidelines for Zen Miraculous AI lead automation services." },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Privacy Policy — Zen Miraculous AI" },
      { property: "og:url", content: "https://zenmiraculous.com/privacy" },
    ],
    links: [
      { rel: "canonical", href: "https://zenmiraculous.com/privacy" },
    ],
  }),
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-[#fafafa]">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between border-b border-[#27272a] bg-[#09090b] px-6 py-3.5">
        ...
        <a href="/" className="text-sm font-semibold text-[#f59e0b] no-underline hover:text-[#d97706]">
          ← Back to Home
        </a>
      </nav>
      ...
      <main className="mx-auto max-w-[760px] px-6 pb-24 pt-14">
        <h1 className="mb-2 text-[clamp(28px,4vw,42px)] font-bold text-[#fafafa]">
          Privacy Policy
        </h1>
        <p className="mb-12 text-xs text-[#71717a]">
...
Calendly: calendly.com/harshvyas242424/business-automation-audit`,
          ...
          <div key={section.title} className="mb-9">
            ...
            {section.content.split("\n").map((line, i) =>
              line.trim() === "" ? null : (
                <p key={i} className="mb-2 text-sm leading-relaxed text-[#a1a1aa]">
                  {line}
                </p>
              )
            )}
        ...
        <div className="mt-12 border-t border-[#27272a] pt-8">
          <a
            href="/"
            className="inline-block rounded-lg bg-[#f59e0b] px-7 py-3 text-sm font-semibold text-[#1c1917] no-underline hover:bg-[#d97706]"
          >
            ← Back to Home
          </a>
        </div>
